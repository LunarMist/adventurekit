...
// Flags for ImGuiFreeType::BuildFontAtlas()
export { ImGuiFreeTypeRasterizerFlags as FreeTypeRasterizerFlags };
export enum ImGuiFreeTypeRasterizerFlags {
...
export function FreeTypeBuildFontAtlas(atlas: ImFontAtlas, extra_flags: number = 0) : boolean {
    return bind.FreeTypeBuildFontAtlas(atlas.native, extra_flags);
}
