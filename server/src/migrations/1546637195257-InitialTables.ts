...
export class InitialTables1546637195257 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying(15) NOT NULL, "email" character varying(120) NOT NULL, "password_hash" character varying(80) NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "verified_email" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "game_room" ("id" SERIAL NOT NULL, "password_hash" character varying(80), "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" integer, CONSTRAINT "PK_fa4083cccb79a3e4786a991000b" PRIMARY KEY ("id"))`);
