...
export class EventSourcingV11551848989930 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('CREATE TABLE "event_aggregate" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "roomId" integer NOT NULL, "category" character varying(40) NOT NULL, "eventWatermark" integer NOT NULL, "dataVersion" integer NOT NULL, "data" bytea NOT NULL, CONSTRAINT "UQ_f54fd4239ad97c5e11d452d03af" UNIQUE ("roomId", "category"), CONSTRAINT "PK_46fbdf8b3fc87781d05fbf11b90" PRIMARY KEY ("id"))');
    ...
    await queryRunner.query('CREATE TABLE "event" ("id" SERIAL NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "roomId" integer NOT NULL, "category" character varying(40) NOT NULL, "sequenceNumber" integer NOT NULL, "source" integer NOT NULL, "dataVersion" integer NOT NULL, "data" bytea NOT NULL, CONSTRAINT "UQ_1bff8f5bb663673f8f377512cec" UNIQUE ("roomId", "category", "sequenceNumber"), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))');
